    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button @click="list(scope.row)" type="text" size="small">查看车辆</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  ...
  watch: {
    ruleForm: {
      handler(newRuleForm, oldRuleForm) {
        ...
        that.total = null
        that.tableData = null
        const url = this.$url + '/api/client/queryByCountAndRate'
  ...
  methods: {
    ...
    deleteTeacher(row) {
      const that = this
      const url = this.$url + '/api/client/delete'
      console.log(row)
